...
# This is based on a survey https://github.com/search?q=.zshrc

# To migrate from Bash without repeating:
source ~/.bash_profile

# If you come from bash on Apple M1 Monterey: /opt/homebrew/bin is where Zsh looks for brew (instead of /usr/local/bin):
